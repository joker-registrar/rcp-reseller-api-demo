...
"_bingo_tld" => "/^CODO[0-9]+$/i",
"_chat_tld" => "/^CODO[0-9]+$/i",
"_style_tld" => "/^CODO[0-9]+$/i",
"_tennis_tld" => "/^CODO[0-9]+$/i",
"_apartments_tld" => "/^CODO[0-9]+$/i",
"_casino_tld" => "/^CODO[0-9]+$/i",
"_football_tld" => "/^CODO[0-9]+$/i",
"_school_tld" => "/^CODO[0-9]+$/i",
"_gold_tld" => "/^CODO[0-9]+$/i",
"_golf_tld" => "/^CODO[0-9]+$/i",
"_plus_tld" => "/^CODO[0-9]+$/i",
"_tours_tld" => "/^CODO[0-9]+$/i",
"_cafe_tld" => "/^CODO[0-9]+$/i",
"_express_tld" => "/^CODO[0-9]+$/i",
"_dog_tld" => "/^CODO[0-9]+$/i",
"_theater_tld" => "/^CODO[0-9]+$/i",
"_date_tld" => "/^CDAT-[0-9]+$/i",
"_faith_tld" => "/^CFAI-[0-9]+$/i",
"_review_tld" => "/^CREV-[0-9]+$/i",
"_site_tld" => "/^CCEN-[0-9]+$/i",
"_reise_tld" => "/^CODO[0-9]+$/i",
"_news_tld" => "/^CRIG[0-9]+$/i",
"_accountant_tld" => "/^CACC-[0-9]+$/i",
"_download_tld" => "/^CDOW-[0-9]+$/i",
"_racing_tld" => "/^CRAC-[0-9]+$/i",
"_loan_tld" => "/^CLOA-[0-9]+$/i",
"_win_tld" => "/^CWIN-[0-9]+$/i",
"_lol_tld" => "/^CUNR-[0-9]+$/i",
"_taxi_tld" => "/^CODO[0-9]+$/i",
"_hockey_tld" => "/^CODO[0-9]+$/i",
"_run_tld" => "/^CODO[0-9]+$/i",
"_tech_tld" => "/^CCEN-[0-9]+$/i",
"_soccer_tld" => "/^CODO[0-9]+$/i",
"_coupons_tld" => "/^CODO[0-9]+$/i",
"_fyi_tld" => "/^CODO[0-9]+$/i",
"_mba_tld" => "/^CODO[0-9]+$/i",
"_college_tld" => "/^CCEN-[0-9]+$/i",
"_online_tld" => "/^CCEN-[0-9]+$/i",
"_love_tld" => "/^CCEN-[0-9]+$/i",
"_fans_tld" => "/^CCEN-[0-9]+$/i",
"_tickets_tld" => "/^CCEN-[0-9]+$/i",
"_rent_tld" => "/^CCEN-[0-9]+$/i",
"_irish_tld" => "/^CONX-[0-9]+$/i",
"_adult_tld" => "/^CONX-[0-9]+$/i",
"_porn_tld" => "/^CONX\-[0-9]+$/i",
"_ski_tld" => "/^CSTA-[0-9]+$/i",
"_bio_tld" => "/^CSTA-[0-9]+$/i",
"_ltda_tld" => "/^CONX-[0-9]+$/i",
"_green_tld" => "/^CAFI-[0-9]+$/i",
"_live_tld" => "/^CRIG[0-9]+$/i",
"_studio_tld" => "/^CRIG[0-9]+$/i",
"_srl_tld" => "/^CONX-[0-9]+$/i",
"_sex_tld" => "/^CONX-[0-9]+$/i",
"_pro_tld" => "/^CAFI-[0-9]+$/i",
"_hiv_tld" => "/^CUNR-[0-9]+$/i",
"_family_tld" => "/^CRIG[0-9]+$/i",
"_vin_tld" => "/^CODO[0-9]+$/i",
"_wine_tld" => "/^CODO[0-9]+$/i",
"_car_tld" => "/^CUNR-[0-9]+$/i",
"_cars_tld" => "/^CUNR-[0-9]+$/i",
"_auto_tld" => "/^CUNR-[0-9]+$/i",
"_bet_tld" => "/^CAFI-[0-9]+$/i",
"_pet_tld" => "/^CAFI-[0-9]+$/i",
"_protection_tld" => "/^CCEN-[0-9]+$/i",
"_security_tld" => "/^CCEN-[0-9]+$/i",
"_theatre_tld" => "/^CCEN-[0-9]+$/i",
"_feedback_tld" => "/^CCEN-[0-9]+$/i",
"_men_tld" => "/^CARI-[0-9]+$/i",
"_store_tld" => "/^CCEN-[0-9]+$/i",
"_cloud_tld" => "/^CARI-[0-9]+$/i",
"_club_tld" => "/^CCLU-[0-9]+$/i",
"_vip_tld" => "/^CMIN-[0-9]+$/i",
"_mom_tld" => "/^CUNR-[0-9]+$/i",
);
// 		"_auth_id"	    => '/^[\x20-\x7e]*$/i',
